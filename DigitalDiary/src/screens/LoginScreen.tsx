          ...
          <View style={[styles.desktopCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            >
              <View style={styles.heroContent}>
                ...
                <Text style={styles.heroTitle}>Your Personal Digital Journal</Text>
                <Text style={styles.heroSubtitle}>
                  Capture memories, write daily entries, add photos, and sketch drawings securely.
                </Text>
                <View style={styles.featureList}>
                  <View style={styles.featureItem}>
                    <Text style={styles.featureIcon}>🔒</Text>
                    <Text style={styles.featureText}>100% Private & Biometric Protected</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <Text style={styles.featureIcon}>🎨</Text>
                    <Text style={styles.featureText}>Handwritten Notes & Drawing Pad</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <Text style={styles.featureIcon}>📅</Text>
                    <Text style={styles.featureText}>Interactive Calendar & Timeline</Text>
                  </View>
                  <View style={styles.featureItem}>
                    <Text style={styles.featureIcon}>🌙</Text>
                    <Text style={styles.featureText}>Dark Mode & Custom Themes</Text>
                  </View>
                </View>
              </View>
            </LinearGradient>
